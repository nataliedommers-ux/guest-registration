...
module.exports = async function handler(req, res) {
  ...
  await slack.views.open({
    ...
    view: {
      ...
      blocks: [
        { type: 'input', block_id: 'office', label: { type: 'plain_text', text: 'Office' }, element: { type: 'static_select', action_id: 'office_select', placeholder: { type: 'plain_text', text: 'Select an office' }, options: [ { text: { type: 'plain_text', text: 'NYC' }, value: 'nyc' }, { text: { type: 'plain_text', text: 'SF' }, value: 'sf' }, { text: { type: 'plain_text', text: 'London' }, value: 'london' } ] } },
